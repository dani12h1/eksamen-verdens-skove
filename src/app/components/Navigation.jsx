        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          <ul className="hidden md:hidden lg:flex space-x-6 pl-[20vw]">
            <li className="flex relative group" ref={submenuRef}>
              ...
              <ul className={`submenu absolute bg-[#507D66] space-y-4 p-6 w-[350px] h-62 top-[225%] transform ${openMenu === 0 ? "scale-100" : "scale-0"} transition duration-200 ease-in-out origin-top shadow-lg text-white border-t-8 border-orange z-[100001]`}>
            ...
            <li className="flex relative group" ref={submenuRef}>
              ...
              <ul className={`submenu absolute bg-[#507D66] space-y-4 p-6 w-[350px] h-62  top-[225%] transform ${openMenu === 1 ? "scale-100" : "scale-0"} transition duration-200 ease-in-out origin-top shadow-lg text-white border-t-8 border-orange z-[100001]`}>
