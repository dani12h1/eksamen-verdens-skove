...
import uganda from "../../billeder/uganda-kopi.png";
import nicaragua from "../../billeder/nicaragua-kopi.png";
    ...
    <>
      ...
      <main className="leading-8 ">
        <section className="relative">
          ...
          <h1 className="text-white absolute top-[6rem] lg:pl-[6vw] pl-[6vw] lg:pt-[25vw]  md:pl-[6vw] md:pt-[20vw] pb-4">Globalt Arbejde</h1>
        </section>
        <div className=" lg:p-0 mx-22 my-14">
          ...
          <section className="bg-lys_grå md:p-10 p-4">
            ...
            <div className="flex md:overflow-scroll overflow-scroll p-6 gap-5 lg:gap-20 lg:justify-center lg:items-center">
              ...
              <div className="cursor-pointer">
                <Image className="rounded-full mb-4 border-gray border-2 min-w-[120px] min-h-[120px] lg:max-w-[150px] p-3 bg-hvid   " src={honduras} alt="Picture of Nicaragua" />
          ...
          <section className="p-3 lg:mx-32 ">
            ...
            <div className="lg:flex lg:p-10 md:flex md:p-10">
              ...
              <div className="lg:flex lg:flex-col lg:justify-center lg:p-9 md:flex md:flex-col md:justify-center md:p-9 lg:max-w-[1000px] ">
                <h2 className="pt-5 leading-10  lg:pl-8"> Hvordan vi støtter de oprindelige folk</h2>
