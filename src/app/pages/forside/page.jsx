      ...
      <main className="leading-12 ">
        ...
        <section className="relative ">
          ...
          <div className="lg:flex">
            <div className="absolute top-52 lg:top-52 md:top-52 w-full h-full flex justify-center lg:justify-end md:justify-end md:pr-28 lg:pr-48  items-center ">
        ...
        <div className="bg-white m-4 lg:m-28 md:m-22">
          ...
          <section className="w-full h-full  mx-auto border-t-2 lg:pt-20 border-black">
          ...
          <section className="lg:pb-28">
            ...
            <div>
              <button className="text-orange pt-7">Flere artikler →</button>
            </div>
          </section>
        </div>
